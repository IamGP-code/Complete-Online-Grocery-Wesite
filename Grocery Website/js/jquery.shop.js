(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Grocery-"; // Prefix string to be prepended to the cart's name in the session storage
		...
		emptyCart: function() {
			...
			if( self.$emptyCartBtn.length ) {
				self.$emptyCartBtn.on( "click", function() {
					self._emptyCart();
					alert('Cart is Empty , Please Go to Shopping tab to Add the Items')
				});
			}
		},
